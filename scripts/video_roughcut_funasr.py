...
<head>
  <meta charset="utf-8" />
  <title>Dasheng Video Roughcut Review</title>
  <style>
...
<body>
  <header>
    <strong>Dasheng Video Roughcut Review</strong>
...
server.listen(port, () => {
  console.log(`Dasheng roughcut review server: http://localhost:${port}/`);
});
'''
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Dasheng FunASR-based talking-head rough cut")
