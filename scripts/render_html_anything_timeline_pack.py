...
.paper .mono{color:#d6a84e;letter-spacing:.14em}.paper h1{font-size:52px;line-height:1.12;margin:14px 0 20px;max-width:1500px}.paper>p:last-child{font-size:25px;line-height:1.45;color:#c2cbd2;margin:18px 0 0;max-width:1500px}
