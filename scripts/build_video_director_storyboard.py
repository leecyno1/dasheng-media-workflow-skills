...
<body>
  ...
  <footer>Dasheng Video Director · storyboard first, render after review.</footer>
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build an auditable Dasheng video director storyboard from an article HTML.")
