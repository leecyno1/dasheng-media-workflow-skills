...
This is for Dasheng video review/final renders where TTS has real pauses that
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Align Dasheng Remotion subtitles to ASR timing.")
