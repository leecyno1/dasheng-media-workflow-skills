#!/usr/bin/env python3
"""Create and update a Dasheng project run manifest."""
...
def build_manifest(
    *,
    ...
    timestamp = now_iso()
    return {
        "schema_version": "dasheng.project_run_manifest.v1",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create and update Dasheng project run manifests.")
