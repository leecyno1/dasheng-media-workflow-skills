...
def build_renderer_contract() -> dict[str, Any]:
    return {
        ...
        "renderer": "DashengRemotionDirectorPack",
...
def build_showcase_plan() -> dict[str, Any]:
    ...
    return {
        ...
        "aspect": "16:9",
        "title": "Dasheng Renderer Family Showcase",
        "fps": 30,
        "width": 1920,
        "height": 1080,
        "source_video": "",
...
def write_renderer_project(
    ...
    *,
    ...
    payload.setdefault("width", 1920)
    payload.setdefault("height", 1080)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build the Dasheng Remotion director renderer project.")
