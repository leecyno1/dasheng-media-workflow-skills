...
def build_review_html(output: Path, catalog: list[dict[str, Any]], full_data: dict[str, Any]) -> None:
    ...
    html = f"""<!doctype html>
<meta charset="utf-8">
<title>Dasheng Video Review Suite</title>
<style>
...
<h1>Dasheng Video Review Suite</h1>
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build Dasheng video template / voice / full-scene review suite.")
