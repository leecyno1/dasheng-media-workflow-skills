...
安全要求：通过 `SAU_DATA_DIR=~/Library/Application Support/DashengPublishSessions/qianfan-sync` 外置数据库、Cookie、日志和上传缓存。使用 `python3 scripts/start_publish_console.py --confirm-start` 启动，访问 `http://127.0.0.1:5173`。
