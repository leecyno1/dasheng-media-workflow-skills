# 如果冲突开始长期化，真正要重估的可能不是战况，而是供给秩序 素材执行手册
...
- 统一执行器：`/Volumes/PSSD/Projects/公众号文章/scripts/material_execute_pack.sh --pack-root /path/to/pack_assets/topic-6 --steps charts,image_search,video_search,ai_prep`
