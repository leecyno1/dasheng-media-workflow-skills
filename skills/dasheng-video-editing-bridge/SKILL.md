...
description: Use when a request asks for end-to-end video editing and Dasheng must choose between its internal director pipeline, chengfeng-videocut, video-use, Jianying, or another reviewed provider without losing review gates.
---

# Dasheng Video Editing Bridge
...
| --- | --- | --- |
| internal Dasheng pipeline | evidence-heavy finance video, director-level control, custom animation, repeatable review | default |
...
5. Import external output as a work copy. Probe it and run Dasheng render/QC gates before calling it final.
