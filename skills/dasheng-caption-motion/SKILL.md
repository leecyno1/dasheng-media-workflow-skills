...
description: Use when SRT, VTT, ASR segments, or word timestamps must drive animated subtitles, keyword emphasis, kinetic typography, lower thirds, or timed chart callouts in a Dasheng video using HyperFrames or Remotion.
---

# Dasheng Caption Motion
