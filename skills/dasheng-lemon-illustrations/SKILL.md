...
description: Use when a talking-head or no-human video needs a conceptual cartoon insert, visual metaphor, process illustration, emotional beat, or transition asset. Generates the Dasheng lemon-person illustration system derived from helloianneo/ian-xiaohei-illustrations while preserving real charts, screenshots, tables, and evidence.
---
