# 全球央行大规模抛售美债引发金融市场系统性风险担忧 素材执行手册
...
- 推荐主链命令：`/Volumes/PSSD/Projects/公众号文章/scripts/material_execute_pack.sh --draft-manifest /path/to/draft_manifest.json --topic-dir t003 --steps charts,image_search,video_search,ai_prep`
- 兼容命令：`/Volumes/PSSD/Projects/公众号文章/scripts/material_execute_pack.sh --pack-root /path/to/pack_assets --topic-dir t003 --steps charts,image_search,video_search,ai_prep`
