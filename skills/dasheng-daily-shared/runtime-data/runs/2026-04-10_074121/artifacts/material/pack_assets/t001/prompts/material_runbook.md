...
- 推荐主链命令：`/Volumes/PSSD/Projects/公众号文章/scripts/material_execute_pack.sh --draft-manifest /path/to/draft_manifest.json --topic-dir t001 --steps charts,image_search,video_search,ai_prep`
- 兼容命令：`/Volumes/PSSD/Projects/公众号文章/scripts/material_execute_pack.sh --pack-root /path/to/pack_assets --topic-dir t001 --steps charts,image_search,video_search,ai_prep`
