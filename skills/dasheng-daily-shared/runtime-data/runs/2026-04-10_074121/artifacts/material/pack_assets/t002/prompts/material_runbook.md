# 中东冲突与霍尔木兹海峡封锁导致油价坚挺形成全球能源供应链风险 素材执行手册
...
- 推荐主链命令：`/Volumes/PSSD/Projects/公众号文章/scripts/material_execute_pack.sh --draft-manifest /path/to/draft_manifest.json --topic-dir t002 --steps charts,image_search,video_search,ai_prep`
- 兼容命令：`/Volumes/PSSD/Projects/公众号文章/scripts/material_execute_pack.sh --pack-root /path/to/pack_assets --topic-dir t002 --steps charts,image_search,video_search,ai_prep`
