# 半导体突然很热闹，但行业最危险的误判可能才刚开始 素材执行手册
...
- 统一执行器：`/Volumes/PSSD/Projects/公众号文章/scripts/material_execute_pack.sh --pack-root /path/to/pack_assets/topic-10 --steps charts,image_search,video_search,ai_prep`
