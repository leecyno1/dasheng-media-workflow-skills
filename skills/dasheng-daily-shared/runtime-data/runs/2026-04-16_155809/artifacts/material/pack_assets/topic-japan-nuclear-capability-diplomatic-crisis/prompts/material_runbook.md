# 日本核武器能力披露背后：从和平宪法到军事化的结构性转变 素材执行手册
...
- 推荐主链命令：`/Volumes/PSSD/Projects/公众号文章/scripts/material_execute_pack.sh --draft-manifest /path/to/draft_manifest.json --topic-dir topic-japan-nuclear-capability-diplomatic-crisis --steps charts,image_search,video_search,ai_prep`
